...
if(isset($_POST['register'])){
    ...
    $result = mysqli_query($connection, $query);
        ...
        else { $message = "That username already exists!"; 
    }    
...
//    header( "refresh:0.5;url=registerPage.php" );
...
<!--    <h2 class="lr-title">Register</h2>-->
  ...
  <form action="registerPage.php" method="post">
    ...
    <input autocomplete="off" class="pw_login" type="password" id="" name="password" placeholder="password ..">
